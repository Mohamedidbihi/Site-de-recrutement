                ...
                <form method="post" action="{{ route('addoffre')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="titre" placeholder="Titre"
                            class="form-control @error('titre')border border-danger" @enderror"
                            value="{{old('titre')}}" />
                        @error('titre')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="secteur" class="form-control @error('secteur')border border-danger" @enderror"
                            value="{{old('secteur')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="diplome" name="diplome" class="form-control @error('diplome')border border-danger"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="experience" name="experience"
                            class="form-control @error('experience')border border-danger" @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="ville" name="ville" class="form-control @error('ville')border border-danger"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Typeoffre" name="Typeoffre"
                            class="form-control @error('Typeoffre')border border-danger" @enderror"
                            value="{{old('Typeoffre')}}">
                            <option value="" selected disabled>-Selectionner-</option>
        ...
        <div class="row my-5">
            ...
            <div class="col table-responsive ">
                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                    data-bs-target="#modalForm"><i class="fas fa-plus"></i> Nouvelle Offre</button>
                <br> <br>
                @if(session('status'))
                ...
                @endif
                <table class="table bg-white rounded shadow-sm table-responsive  table-hover">
                    <thead>
                        <tr>
                                ...
                                <ul class="list-inline m-0">
                                    ...
                                    <form action="{{ route('Activer', $offre->id ) }}" method="post" class="d-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <button type="submit" class="btn btn-success btn-sm rounded-0"
                                                title="Valider"><i class="far fa-thumbs-up"></i></button>
                                        </li>
                                    </form>
                                    ...
                                    <form action="{{ route('En_attente',$offre->id) }}" method="post" class="d-inline">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            <button class="btn btn-warning btn-sm rounded-0" type="submit"
                                                data-toggle="tooltip" data-placement="top" title="Mettre en attente"><i
                                    ...
                                    <form action="{{ route('Refuser', $offre->id ) }}" method="post" class="d-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <button class="btn btn-danger btn-sm rounded-0" type="submit"
                                                data-toggle="tooltip" data-placement="top" title="Refuser"><i
